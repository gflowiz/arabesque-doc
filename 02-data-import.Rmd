...
For more informations about the dataset and its use with Arabesque, see in [Examples](#examples).

_Arabesque_ accepts input files in the following format: .CSV, .JSON and .geoJSON.
