...
> The central panel is for displaying the map and the two side panels is for playing with geographic and statistical information. The right panel is for playing with the flow data set and the right panel is for dealing with the statistics.
